# Original -------------------
resultModel <- readRDS("inst/shiny/ResultsExplorer/data/linear_t1000_e2000_w1_cdm_optum_ehr_covid_v1547.rds")
...
TimeSeriesAnalysis::plotCpdSegmented(Samples = dexTrend$eventCount, 
